...
<html lang="en">
    ...
    <body>
        ...
        <div id="confirmation">
        <h1 id="confirmationTitle">Email Sent.</h1>
        <div id="confirmationInfo">We have sent an your email please click the link to activate your account. Don't forget to check junk.</div>
        </div>
        <footer>
            <div>
