...
$localHostSiteFolderName = "Login_CA2";
...
$serverWebsiteName = "https://www.williamhadnett.space"; /* use this address if hosting website on the college students' website server */
